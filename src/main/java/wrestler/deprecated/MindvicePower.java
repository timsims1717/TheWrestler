...
public class MindvicePower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;
    public boolean appliedToPlayer;
    public int oldAmount;

    public static final String POWER_ID = wrestler.Wrestler.makeID(MindvicePower.class.getSimpleName());
    ...
    public MindvicePower(final AbstractCreature owner, final AbstractCreature source, final int amount, final boolean appliedToPlayer) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new MindvicePower(owner, source, amount, appliedToPlayer);
    }
}
