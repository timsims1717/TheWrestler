...
public class InfectionPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = wrestler.Wrestler.makeID(InfectionPower.class.getSimpleName());
    ...
    public void atEndOfTurn(boolean isPlayer) {
        if (amount >= owner.currentHealth) {
            ...
            addToBot(new ApplyPowerAction(owner, owner, new InfectionPower(owner, owner, amount), amount));
        }
    }
