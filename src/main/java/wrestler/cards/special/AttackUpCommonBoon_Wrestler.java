...
public class AttackUpCommonBoon_Wrestler extends AbstractWrestlerCard {

    // TEXT DECLARATION

    public static final String ID = wrestler.Wrestler.makeID(AttackUpCommonBoon_Wrestler.class.getSimpleName());
    ...
    public AttackUpCommonBoon_Wrestler() {
