...
public class Backbreaker_Wrestler extends AbstractWrestlerCard {

    // TEXT DECLARATION

    public static final String ID = wrestler.Wrestler.makeID(Backbreaker_Wrestler.class.getSimpleName());
