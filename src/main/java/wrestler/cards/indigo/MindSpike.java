...
public class MindSpike extends AbstractWrestlerCard {

    // TEXT DECLARATION

    public static final String ID = wrestler.Wrestler.makeID(MindSpike.class.getSimpleName());
    public static final String IMG = makeCardPath("MindSpike.png");
